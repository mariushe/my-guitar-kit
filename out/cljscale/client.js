...
cljscale.client.settings = cljs.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"root","root",-448657453),"",new cljs.core.Keyword(null,"scale","scale",-230427353),""], null));
...
return cljscale.generator.create_fretboard.call(null,cljscale.generator.e_standard,(24));
}));
...
return quiescent.dom.div.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),"selections row"], null),cljscale.client.Root.call(null),cljscale.client.Scale.call(null));
}),cljs.core.PersistentArrayMap.EMPTY);
/**
 * 
 */

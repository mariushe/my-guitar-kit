...
cljscale.generator.tunes = new cljs.core.PersistentArrayMap(null, 2, ["Standard (E A D G B E)",new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["E","B","G","D","A","E"], null),"Drop D (D A D G B E)",new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, ["E","B","G","D","A","D"], null)], null);
...
var G__34413 = cljscale.generator.note_map.call(null,note);
var G__34414 = (rest - (1));
note = G__34413;
rest = G__34414;
continue;
...
return cljs.core.assoc.call(null,note,new cljs.core.Keyword(null,"in-scale","in-scale",465354433),!(cljs.core.not_any_QMARK_.call(null,(function (p1__34415_SHARP_){
return cljs.core._EQ_.call(null,note.call(null,new cljs.core.Keyword(null,"note","note",1426297904)),p1__34415_SHARP_);
}),scale)));
});
...
var G__34416 = cljs.core.conj.call(null,res,cljscale.generator.create_note.call(null,next));
var G__34417 = next;
var G__34418 = (frets_left - (1));
res = G__34416;
note = G__34417;
frets_left = G__34418;
continue;
